...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to bitenxd "gobject list" output
    ...
    def bitenxd_serialise(self):
        import bitenxlib
        return bitenxlib.SHIM_serialise_for_bitenxd(self.serialise())
