...
min_bitenxd_proto_version_with_sentinel_ping = 70207


def get_bitenx_conf():
    home = os.environ.get('HOME')

    bitenx_conf = os.path.join(home, ".bitenxcore/bitenx.conf")
    if sys.platform == 'darwin':
        bitenx_conf = os.path.join(home, "Library/Application Support/DashCore/bitenx.conf")

    bitenx_conf = sentinel_cfg.get('bitenx_conf', bitenx_conf)
