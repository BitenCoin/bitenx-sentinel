...
class DashDaemon():
    def __init__(self, **kwargs):
        ...
        # memoize calls to some bitenxd methods
    ...
    @classmethod
    def from_bitenx_conf(self, bitenx_dot_conf):
        from bitenx_config import DashConfig
        config_text = DashConfig.slurp_config_file(bitenx_dot_conf)
    ...
    def get_my_gobject_votes(self, object_hash):
        ...
        if not self.gobject_votes.get(object_hash):
            ...
            self.gobject_votes[object_hash] = bitenxlib.parse_raw_votes(raw_votes)
    ...
    def we_are_the_winner(self):
        ...
        winner = bitenxlib.elect_mn(block_hash=current_block_hash, mnlist=mn_list)
        my_vin = self.get_current_masternode_vin()
    ...
    def estimate_block_time(self, height):
        ...
        future_seconds = bitenxlib.blocks_to_seconds(diff)
    ...
    def has_sentinel_ping(self):
        ...
        return (getinfo['protocolversion'] >= config.min_bitenxd_proto_version_with_sentinel_ping)
